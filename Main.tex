...
\newacronym{procsc}{proCSC}{hyper-proliferative Colonic Stem Cell}
\newacronym{revcsc}{revCSC}{revival Colonic Stem Cell}
...
\newacronym{da}{DA}{differential abundance}
...
\include{00preamble/00pre}
\include{01intro/01intro}
\include{02methods/02methods}
\include{03cytof/03cytof}
\include{04seq/04seq}
\include{05vr/05vr}
\include{06kg/06kg}
\include{07disc/07disc}
\include{0Xappendices/0Xappendices}
