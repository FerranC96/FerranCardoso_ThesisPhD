...
% Current text in here comes from the Upgrade report (one of the few cases where self-plagiarism does not apply) and is mostly a placeholder.
...
% oncogenic mutations targeting \textit{Apc}, \textit{Kras}, \textit{Braf}, \textit{Smad4}, and/or \textit{Trp53} constitute intrinsic cues that induce a crypt-progenitor phenotype in CRC cells \cite{vandewetering_betacatenin_2002}
...
While the revCSC state has been associated with \colorbox{yellow}{Hippo} and \colorbox{yellow}{Yap} signalling, their exact role in relapse and the mechanisms driving the balance between revival and proliferative CSCs remain unclear.
...
% \colorbox{yellow}{GROUP/TRIM REFS. Friend or foe 2017 review}
...
\section{Single-Cell Omic Data Analysis}
...
\colorbox{yellow}{WORK IN PROGRESS}
